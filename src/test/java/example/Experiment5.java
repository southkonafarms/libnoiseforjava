...
public class Experiment5 {
	...
	private static Integer GRID_WIDTH = 256;
	// Height of elevation grid, in points
	private static Integer GRID_HEIGHT = 256/2;
	...
	private static Double CONTINENT_FREQUENCY = 0.5;
	...
	private static Spheres pools = new SpheresBuilder().build(1000.0);
	...
	static private Curve baseContinentDef_cu = new Curve(pools);
	static {
