...
public class NoiseMapBuilderCylinder extends NoiseMapBuilder {
	...
	public void build() throws ExceptionInvalidParam {
		if (upperAngleBound <= lowerAngleBound || upperHeightBound <= lowerHeightBound || destWidth <= 0
				|| destHeight <= 0 || sourceModule == null || destNoiseMap == null)
	...
	public void setBounds(double lowerAngleBound, double upperAngleBound, double lowerHeightBound,
			double upperHeightBound) throws ExceptionInvalidParam {
