...
public class Select extends ModuleBase {
	...
	public Select(ModuleBase sourceModuleOne, ModuleBase sourceModuleTwo, ModuleBase sourceModuleThree)
	...
	public double getValue(double x, double y, double z) {
		...
		if (edgeFalloff > 0.0) {
			if (controlValue < (lowerBound - edgeFalloff))
				...
				return Interp.linearInterp(sourceModules[0].getValue(x, y, z), sourceModules[2].getValue(x, y, z),
						alpha);
				...
				alpha = Interp.SCurve3((controlValue - lowerCurve) / (upperCurve - lowerCurve));
				return Interp.linearInterp(sourceModules[1].getValue(x, y, z), sourceModules[0].getValue(x, y, z),
						alpha);
			} else
