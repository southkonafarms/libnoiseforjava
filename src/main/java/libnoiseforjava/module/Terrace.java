...
public class Terrace extends ModuleBase {
	...
	public double getValue(double x, double y, double z) {
		...
		// tough debugging
			...
			logger.error("Source Module:" + sourceModules[0] + " generated null pointer exception " + fake
					+ " fake value generated");
			return fake;
		}
	...
	public String toString() {
		return "Terrace [controlPointCount=" + controlPointCount + ", invertTerraces=" + invertTerraces
