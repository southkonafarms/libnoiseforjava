...
public class Cached extends ModuleBase {
	private static Logger logger = Logger.getLogger(Cached.class);
	...
	public String toString() {
		return "Cached [cachedValue=" + cachedValue + ", isCached=" + isCached + ", xCache=" + xCache + ", yCache="
				+ yCache + ", zCache=" + zCache + ", sourceModules=" + Arrays.toString(sourceModules)
