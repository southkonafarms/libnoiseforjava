...
public class Curve extends ModuleBase {
	...
	public double getValue(double x, double y, double z) {
		...
		return Interp.cubicInterp(controlPoints[index0].outputValue, controlPoints[index1].outputValue,
				controlPoints[index2].outputValue, controlPoints[index3].outputValue, alpha);
	}
