...
public class Voronoi extends ModuleBase {
	...
	public double getValue(double x, double y, double z) {
		...
		return value + (displacement * (double) NoiseGen.ValueNoise3D((int) (Math.floor(xCandidate)),
				(int) (Math.floor(yCandidate)), (int) (Math.floor(zCandidate)), seed));// added
																						// seed
																						// here,
																						// not
																						// in
	...
	public String toString() {
		return "Voronoi [displacement=" + displacement + ", enableDistance=" + enableDistance + ", frequency="
				+ frequency + ", seed=" + seed + "]";
	}
