...
public interface OddPlanarTerranIF {
	
	public static Double sea_level = -0.5;
	
	public static Double min_elev = -10192.0;
	// maximum elevation on the planet, in meters. this value is approximate.
	public static Double max_elev = 10192.0;
	...
	static public Double deep_sea_level = -148.0;
	static public Double mountains_amount = 0.7;
