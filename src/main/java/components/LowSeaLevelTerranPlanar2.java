...
public class LowSeaLevelTerranPlanar2 extends Planar implements LowSeaLevelPlanarTerranIF{
	...
	protected static LowSeaLevelTerranPlanar2 terranPlanar = new LowSeaLevelTerranPlanar2();
