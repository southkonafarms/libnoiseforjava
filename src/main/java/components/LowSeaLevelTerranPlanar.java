...
public class LowSeaLevelTerranPlanar extends Planar implements LowSeaLevelPlanarTerranIF{
	...
	protected static Integer base_continent_def_octave_count_pe0 = 20;
	protected static Integer base_continent_def_octave_count_pe1 = 15;

	
	protected static Double shelf_level = LowSeaLevelPlanarTerranIF.shelf_level;
	protected static Double mountains_amount = LowSeaLevelPlanarTerranIF.mountains_amount;
	...
	protected static LowSeaLevelTerranPlanar terranPlanar = new LowSeaLevelTerranPlanar();
	...
	public ImageCafe build(Boolean renderParameter) {
		...
		PlanarTerrainType planarTerrainType = new PlanarTerrainType(continent, terrain_type_tu_frequency,
				...
				terrain_type_def_mid_control_point_scalar, terrain_type_def_high_control_point, shelf_level, LowSeaLevelPlanarTerranIF.sea_level);
		...
		PlanarContinentalShelfType planarContinentalShelfType = new PlanarContinentalShelfType(
				...
				continental_shelf_sb_scale, continental_shelf_sb_bias, continental_shelf_cl_bounds, LowSeaLevelPlanarTerranIF.sea_level);
		...
		PlanarContinentsWithMountainsType planarContinentsWithMountainsType = new PlanarContinentsWithMountainsType(
				...
				continent_with_mountains_edge_falloff, continentsWithHills, terrainType, LowSeaLevelPlanarTerranIF.mountains_amount);
		...
		PlanarContinentsWithRiversType planarContinentsWithRiversType = new PlanarContinentsWithRiversType(
				...
				continentsWithBadlands, LowSeaLevelPlanarTerranIF.sea_level, continent_height_scale);
		
		Cached continentsWithRivers = planarContinentsWithRiversType.build();
		
		PlanarFinalType planarFinalType = new PlanarFinalType(LowSeaLevelPlanarTerranIF.max_elev, LowSeaLevelPlanarTerranIF.min_elev, scalar_divisor, continentsWithRivers);
		...
		planet.build();
		RenderImageParameter renderImageParameter = new RenderImageParameter(LowSeaLevelPlanarTerranIF.gradientPointList, elevGrid, renderParameter,
