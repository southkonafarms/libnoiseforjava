...
public class WeirdExample_3 {
	...
	public static void main(String[] args) throws ExceptionInvalidParam {
		...
		try {
			ImageIO.write(im, "png", new File("images/"+ Math.random() +"_weirdExample_3.png"));
