...
public class WeirdExample_2 {
	...
	public static void main(String[] args) throws ExceptionInvalidParam {
		...
		Add combinedGranite = new Add(curve, scaledGrains);
		...
		try {
			ImageIO.write(im, "png", new File("images/"+ Math.random() +"_weirdExample_2.png"));
