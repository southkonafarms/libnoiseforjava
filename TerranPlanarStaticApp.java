...
import libnoiseforjava.util.GenRandomRolls;

public class TerranPlanarStaticApp {
	...
	public static void complexPlanetTest() {
		...
		String uri = "images/" + Math.random() + "complextPlanetCompleteOnly_test.png";
	...
	public static void complexPlanetTest2() {
		...
		ImageCafe imageCafe = Builder.buildRendererImage(renderImageParameter);
		String uri = "images/" + Math.random() + "complextPlanetCompleteOnly_test2.png";
		Output.writer(imageCafe, uri);
